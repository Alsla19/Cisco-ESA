...
ESAClient.connect('10.106.36.220',username='ahsan',password='TheNetworkViking', port='22')
...
#Video Explanation of this script:
#https://www.youtube.com/watch?v=kQL1E-PewPI